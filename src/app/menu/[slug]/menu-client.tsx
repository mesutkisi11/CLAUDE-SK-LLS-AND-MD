...
type MenuItem = {
  ...
  is_available: boolean; sort_order: number; options: string | null;
};
    ...
    <div className="min-h-screen bg-gray-50 pb-32">
      <header className="text-white py-6 px-4 text-center sticky top-0 z-20 shadow-md" style={{ backgroundColor: themeColor }}>
        {logoUrl && (
          ...
          <img src={logoUrl} alt={restaurantName} className="h-12 w-12 rounded-full mx-auto mb-2 object-cover border-2 border-white/30" />
        )}
